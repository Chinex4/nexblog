            ...
            <div className="grid grid-cols-2 gap-12">
                <div className='space-y-6'>
                    ...
                    <div className='space-x-4'>
                        <Link href={route('register')} className='inline-block text-white border border-white px-4 py-2 rounded-md hover:bg-white hover:text-black transition-all duration-300'>
                            Join Community
                        </Link>
                    </div>
                </div>
