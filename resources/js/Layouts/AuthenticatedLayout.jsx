                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={'/blogs'} active={url === "/blogs"}>
                                    Blog Posts
                                </NavLink>
                            </div>
                        </div>
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 space-x-3 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out bg-white border border-transparent rounded-md dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
                                            >
                                                <span className='grid w-10 h-10 overflow-hidden border border-gray-300 rounded-full place-items-center'>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div className="mt-3 space-y-1">
                            <ResponsiveNavLink href={route('profile.show', user)} active={route().current('profile.show')}>Profile</ResponsiveNavLink>
